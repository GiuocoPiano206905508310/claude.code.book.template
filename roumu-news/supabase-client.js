...
// ここに書かないこと（毎日の記事取り込みEdge Functionのみが使用する）。
//
// この給与・勤怠管理システム一式と同じSupabaseプロジェクトを使用している
// （プロジェクトを跨いだ共通化はしていないが、URL/anonキー自体はテーブルの
// アクセス制御（RLS）を破らない限り公開して問題ないキーのため共用できる）。
// ============================================================================
