...
// 給与計算・賞与計算で従業員の給与から天引きする金額の計算に使用する
...
// 厚生労働省「令和8年度雇用保険料率」（労働者負担分＋事業主負担分〔失業等給付・育児休業給付
// ＋雇用保険二事業〕の合計、令和8年4月～令和9年3月）。労働保険 年度更新の雇用保険料
// （会社が申告・納付する金額）の計算に使用する
const EMPLOYMENT_RATES_TOTAL_BY_INDUSTRY = {
  '一般の事業': 1.35, // 労働者負担5/1,000 + 事業主負担8.5/1,000
  '農林水産・清酒製造の事業': 1.55, // 労働者負担6/1,000 + 事業主負担9.5/1,000
  '建設の事業': 1.65, // 労働者負担6/1,000 + 事業主負担10.5/1,000
};
