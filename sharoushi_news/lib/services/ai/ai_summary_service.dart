...
- salaryCalculation: 給与計算に直接関わる情報（保険料率・現物給与価額・所得税や
  住民税の税率・控除額の改定、年末調整・源泉徴収の様式変更、算定基礎届など給与
  計算の実務手続きに関するもの）。制度自体の新設・大きな枠組みの変更はlawChange、
  給与計算実務での数値・様式の変更はsalaryCalculationに分類する。
