...
(function () {
  ...
  /* ============================================================
     ...
     ============================================================ */
  /* 指差しの手。人差し指を上に伸ばし、中指・薬指・小指を段々に折り重ね、
     親指は左上へ向かう独立した指として描く（人差し指との間にV字の切れ込みを作る）。
     輪郭は一本のパスで、親指の線が人差し指の付け根と手首にそのままつながる。 */
  function tutHandInner() {
    return '<g fill="#fff" stroke="#2b2b2b" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round">' +
        '<path d="M14.7 24.3 L14.7 5.2 Q14.7 2.9 17 2.9 Q19.3 2.9 19.3 5.2 L19.3 18.7 L20.3 18.7 L20.3 12.7 Q20.3 10.8 22.2 10.8 Q24.1 10.8 24.1 12.7 L24.1 19.4 L25.1 19.4 L25.1 14.6 Q25.1 13 26.7 13 Q28.3 13 28.3 14.6 L28.3 21.3 L29.3 21.3 L29.3 16.75 Q29.3 15.3 30.75 15.3 Q32.2 15.3 32.2 16.75 L32.2 31 Q32.1 33.3 30.8 34.6 L30.8 35.6 Q30.8 37.6 28.4 37.6 L19 37.6 Q16.8 37.6 16.2 36.2 L6.8 22.2 A2.6 2.6 0 0 1 11.2 19.4 Z"/>' +
      '</g>';
  }
  function tutHandSVG() {
